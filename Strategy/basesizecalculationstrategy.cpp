...
std::vector<QPair<QString, QString> > BaseSizeCalculationStrategy::calculatePercentage(const QMap<QString, qint64> &sizeMap, qint64 totalSize) {
    std::vector<QPair<QString, QString>> percentageList;
